...
export default function Repaso1Screen() {
    ...
    return(
        <ImageBackground
            source={require('../assets/Recursos/imagen5.jpg')}    
            resizeMode='cover'
        ...
        >
            <View style={styles.container}>
                <View style={styles.formBox}>
                  ...
                  <TextInput style={styles.input} placeholder='Ingresa tu nombre' placeholderTextColor="#ffffffff" value={nombre} onChangeText={setNombre}/>
                  <Text style={styles.etiquetas}>Correo Electrónico:</Text>
                  <TextInput style={styles.input} placeholder='Ingresa tu correo electrónico ejemplo@correo.com'placeholderTextColor="#ffffffff" 
                  keyboardType='email-address'autoCapitalize='none'inputType='email'value={correo} onChangeText={setCorreo}/>
                  <View style={styles.terminosContainer}>
                    <Switch value={aceptarTerminos} onValueChange={setAceptaTerminos} trackColor={{false:'grey', true:'#0f37bcff'}} thumbColor={aceptarTerminos ? '#41348aff': '#f4f3f4'}/>
                      <Text style={styles.terminosTexto}>Acepto los términos y condiciones</Text>
                    </View>
                  <View style={styles.botonContainer}>
                    <Button title='Registrarse' onPress={registrarUsuario} color='#0f37bcff'/>
                    </View>
                </View>
            </View>
        </ImageBackground>
