...
import { View, Text, StyleSheet, ImageBackground, Image, TouchableOpacity,StatusBar,Alert } from 'react-native'
  ...
  if (isLoading){
   ...
   return(
    ...
    <View style={styles.mainOverlay}>
      <Text style={styles.welcome}>¡Bienvenido a la galeria!</Text>
      <TouchableOpacity
        style={styles.button}
